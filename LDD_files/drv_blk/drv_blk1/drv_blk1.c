...
#define KERNEL_SECTOR_SIZE	512	// Kernel sector size in units of bytes
#define SECTOR_SHIFT	9	
#define DRV_BLK_MINORS	1		// Number of minor numbers required
...
static int nsectors = 400; // Number of sectors for 200KB RAM disk
...
static int __init drv_blk_init (void)
{
        ...
        snprintf (bdev->gd->disk_name, 32, "cgrd%c", 'a');
